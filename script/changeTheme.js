...
jumbotronNature = document.getElementById('jumbotronTheme');
fontHeaderNature = document.getElementById('headerTitleTheme');
...
function themeNature() {
    ...
    bgNature.classList.toggle('bg_nature');
    jumbotronNature.classList.toggle('jumbotron_nature');
    fontHeaderNature.classList.toggle('font_nature');
...
nature.addEventListener('click', themeNature);
...
jumbotronRubble = document.getElementById('jumbotronTheme');
fontHeaderRubble = document.getElementById('headerTitleTheme');
...
function themeRubble() {

    bgRubble.classList.toggle('bg_rubble');
    jumbotronRubble.classList.toggle('jumbotron_rubble');
    fontHeaderRubble.classList.toggle('font_rubble');
...
rubble.addEventListener('click', themeRubble);

//  theme PJmask //

var bgPJmask;
var jumbotronPJmask;
var fontHeaderPJmask;
var fontTitlePJmask;
...
jumbotronPJmask = document.getElementById('jumbotronTheme');
fontHeaderPJmask = document.getElementById('headerTitleTheme');
...
function themePJmask() {

    bgPJmask.classList.toggle('bg_PJmask');
    jumbotronPJmask.classList.toggle('jumbotron_PJmask');
    fontHeaderPJmask.classList.toggle('font_PJmask');
...
PJmask.addEventListener('click', themePJmask);
...
jumbotronNight = document.getElementById('jumbotronTheme');
...
function themeNight() {
    ...
    bgNight.classList.toggle('bg_night');
    jumbotronNight.classList.toggle('jumbotron_night');
...
night.addEventListener('click', themeNight);
